...
class SimpleHelyxiumLogo3D(QWidget):
    ...
    def paintEvent(self, event):
        ...
        breathing_scale = (
            self.breathing_animation.currentValue()
            if self.breathing_animation.currentValue()
            else 1.0
        )
        ...
        # Draw the helixes
        self._draw_helix(
            painter, center, radius, self.primary_color, self.helix_rotation
        )
        self._draw_helix(
            painter,
            center,
    ...
    def _draw_helix(
        ...
        for i in range(1, len(points)):
            ...
            t = i / len(points)
            angle = (
                2 * math.pi * (i / points_per_turn) * turns + rotation * math.pi / 180
            )
    ...
    def set_theme_colors(self, is_dark_theme: bool):
        ...
        if is_dark_theme:
            ...
            self.primary_color = QColor(
                51, 102, 204, 200
            )  # Standard blue for light theme
            self.secondary_color = QColor(
                204, 51, 102, 200
            )  # Standard red for light theme
