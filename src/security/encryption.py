...
class EncryptionManager:
    ...
    def encrypt_for_transmission(self, data: str, recipient_public_key: bytes) -> str:
        ...
        try:
            ...
            return base64.urlsafe_b64encode(combined_json.encode('utf-8')).decode('ascii')
    ...
    def decrypt_from_transmission(self, encrypted_data: str) -> str:
        ...
        try:
            ...
            combined_json = base64.urlsafe_b64decode(encrypted_data.encode('ascii')).decode('utf-8')
            combined = json.loads(combined_json)
            
            # Decrypt AES key with RSA
            encrypted_aes_key = base64.urlsafe_b64decode(combined['key'].encode('ascii'))
            ...
            aes_cipher = Fernet(aes_key)
            encrypted_content = base64.urlsafe_b64decode(combined['data'].encode('ascii'))
